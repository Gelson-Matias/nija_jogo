...
const shadowColor = '#545353ed';
// How much air drag is applied to standard objects
const airDrag = 0.022;
const gravity = 0.3;
// Spark config
const sparkColor = 'rgba(1,2,2,2)';
const sparkThickness = 15;
const airDragSpark = 0.1;
// Track pointer positions to show trail
const touchTrailColor = 'rgba(1,2,2,2)';
const touchTrailThickness = 10;
const touchPointLife = 150;
const touchPoints = [];
...
const cameraFadeStartZ = 1.45 * cameraDistance;
...
function setupCanvases() {
	...
	function handleResize() {
		...
		viewScale = h / 800;//calcular altura do DOM
		width = w / viewScale;
		height = h / viewScale;
